...
export class Backend implements backendInterface {
    ...
    async getAll(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
    ...
    async remove(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.remove(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async set(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.set(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
